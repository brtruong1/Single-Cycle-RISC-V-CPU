...
# -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { switch }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L23N_T3_35 Sch=led5_r
...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { btn_reset_n }]; #IO_L4P_T0_35 Sch=btn[0]
